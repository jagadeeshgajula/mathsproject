...
<html>
    ...
    <body>
        ...
        <center>
        <table>  
            <x:form action="root_loop">
             <h1><font style="" color="black">FINDING ROOTS UPTO 'N' VALUES</h1>
            <x:textfield class="form-control" label="Enter √x value:" name="rootvalueloop" required="required"/></div>
            <tr>
        <td colspan="2"><br>
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
