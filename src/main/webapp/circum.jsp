<%-- 
    Document   : circum
    Created on : Jul 11, 2017, 12:49:58 PM
    Author     : Dell
--%>
...
<html>
    ...
    <body>
        ...
        <center>
        <table>
        <a:form action="circumference">
           <h1><font style="" color="black">Finding Circumference of circle</h1>
            <a:textfield class="form-control" name="circumradius" label="Enter Radius" required="required"></a:textfield>
           <tr>
        <td colspan="2"><br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
