...
<html>
    <head>
      ...
      <body class="body">
      <center>
      <h1><font style="" color="white"> THE SQUARE ROOT RESULT </h1></font>
      <h3>The <s:property value="rootvalue"/> Square-root value is:<b> <s:property value="result" />
       </h3>
            <a href="root.jsp">
            <button><b>Try Again</b> </button></a>  
        <a href="algebra.html">
