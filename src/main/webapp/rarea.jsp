...
<html>
   <head>
    ...
    <body>
        ...
        <a:form action="rectarea">
             <h1><font style="" color="black">Finding the Area of Rectangle</h1></font>
            <a:textfield class="form-control" name="rlen" label="Enter Length" required="required"></a:textfield>
