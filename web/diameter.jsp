<%-- 
    Document   : diameter
    Created on : Jul 11, 2017, 2:52:13 PM
    Author     : Dell
--%>
...
<html>
    ...
    <body>
        ...
        <center>
        <table>
         <a:form action="diameter">
              <font style=""  size=25 color="black">Finding the Diameter of circle</font>
              <a:textfield  class="form-control" name="diamtrradius" label="Enter Radius" required="required" cssClass="form-control"></a:textfield>
              <tr>
        <td colspan="2"><br>
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
