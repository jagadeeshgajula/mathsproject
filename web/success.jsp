<%-- 
    Document   : success
    Created on : Jul 11, 2017, 11:54:27 AM
    Author     : Dell
--%>
...
<html>
    <head>
      ...
      <body class="body">
      <center>
          <h1><font style="" color="white">Area of the Circle</h1></font>
  <h3>The Area of Circle value is:<b> <s:property value="res"/></h3>
      
           <a href="Login.jsp"><br><br> <button><b>Try Again</b> </button></a> 
