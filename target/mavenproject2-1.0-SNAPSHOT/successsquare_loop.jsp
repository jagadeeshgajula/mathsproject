...
<html>
   <head>
      ...
      <body class="body">
      <center>
      <h1><font style="" color="white">THE RESULT OF SQUARE(X²)LOOP VALUES</h1></font>
      <h3>The <s:property value="squarevalue_loop"/> Square(x ²)value is:<b> <s:property value="result" /></b>
        </h3>  <br>          
          <s:iterator value="results">
      <s:property/><br>
          </s:iterator> 
     
            <a href="suqare_loop.jsp"><br><br><button><b>Try Again</b> </button></a>  
