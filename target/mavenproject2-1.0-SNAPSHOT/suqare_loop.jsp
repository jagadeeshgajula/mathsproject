...
<html>
    ...
    <body>
        ...
        <center>
        <table> 
             <x:form action="square_loop">
             <h1><font style="" color="black"> FINDING SQUARES UPTO 'N' VALUES </h1>
            <x:textfield class="form-control" label="Enter x ² value:" name="squarevalue_loop"/>
            <tr>
        <td colspan="2"><br>
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
