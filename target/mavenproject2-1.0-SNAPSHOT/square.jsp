<%-- 
    Document   : square
    Created on : Jul 11, 2017, 1:39:07 PM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        ...
        <center>
        <table>
        <x:form action="square">
            <h1><font style="" color="black">FIND THE SQUARE VALUES</h1>
                <x:textfield class="form-control" label="Enter x ² value:" name="squarevalue" required="required"/>
               <tr>
        <td colspan="2"><br>
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
