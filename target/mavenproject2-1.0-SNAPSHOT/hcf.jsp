n<%-- 
    Document   : hcf
    Created on : Jul 12, 2017, 11:10:55 AM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        ...
        <table>
            <x:form action="hcf">
            <h1><font style="" color="black"> HCF(Highest Common Factor) </h1>
            <h2> <x:textfield class="form-control" label="Enter m value:" name="hcfvalue" required="required" /> </br>
                <x:textfield class="form-control" label="Enter n value:" name="hcf1value" required="required"/> </h2>
                <tr>
        <td colspan="2"><br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
