<%-- 
    Document   : successadj
    Created on : Jul 12, 2017, 12:04:59 PM
    Author     : Dell
--%>
...
<html>
    <head>
      ...
      <body class="body">
      <center>
  <h1> <font style="" color="white"> THE RESULT Of ADJACENT  </h1></font>    
      
        <h1>The Adjacent Value Is:<s:property value="adjout"></s:property></h1>

            <a href="triadjlogin.jsp"><br><br> <button><b>Try Again</b> </button></a> 
