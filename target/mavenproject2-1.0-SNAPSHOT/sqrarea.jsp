<%-- 
    Document   : square
    Created on : Jul 11, 2017, 3:17:43 PM
    Author     : Dell
--%>
...
<html>
    ...
    <body>
        ...
        <center>
        <table>
        <a:form action="squarearea">
            <center> <h1><font style="" color="black">Finding the Area of Square</h1></font></center>
            <a:textfield class="form-control" name="sqrarea" label="Enter Side" required="required"></a:textfield>
            <tr>
        <td colspan="2"><br>
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
